...
public class SchoolDbContext(DbContextOptions<SchoolDbContext> options) : DbContext(options)
{
    ...
    public DbSet<StudentQrCode> StudentQrCodes => Set<StudentQrCode>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Student>(entity =>
        {
            ...
            entity.HasIndex(e => e.Lrn).HasDatabaseName("idx_students_lrn");
            entity.HasIndex(e => e.StudentNumber).HasDatabaseName("idx_students_student_number");
            entity.HasIndex(e => e.Status).HasDatabaseName("idx_students_status");
        });

        modelBuilder.Entity<StudentQrCode>(entity =>
        {
            entity.ToTable("student_qr_tbl");

            entity.HasKey(e => e.Id);

            entity.Property(e => e.Id).HasColumnName("idstudent_qr").ValueGeneratedOnAdd();
            entity.Property(e => e.StudentId).HasColumnName("student_id").IsRequired();
            entity.Property(e => e.QrContent).HasColumnName("qr_content").HasColumnType("text").IsRequired();
            entity.Property(e => e.QrCode).HasColumnName("qr_code").HasColumnType("longblob").IsRequired();
            entity.Property(e => e.CreatedAt).HasColumnName("created_at");
            entity.Property(e => e.UpdatedAt).HasColumnName("updated_at");

            entity.HasIndex(e => e.StudentId).HasDatabaseName("uq_student_qr").IsUnique();
        });
    }
}
